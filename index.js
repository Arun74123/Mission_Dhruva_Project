...
server.post('/patient', (req, res) => {
    ...
    datad.insert({ name: req.body.name, age: req.body.age,mobile:req.body.mobile,aadh:req.body.aadh, gender: req.body.gender, problem: req.body.problem, status: req.body.status, number: req.body.number, doctor: req.body.doctor,date:req.body.date,link:req.body.link,type:req.body.type,meetlink:req.body.meetlink });
...
server.post('/Docs', (req, res) => {
    ...
    // console.log(req.body.username);
    data.insert({ date: req.body.date, disease: req.body.disease, precaution: req.body.precautions,type:req.body.recordType,prescription:req.body.prescription });
    // console.log(userData);
})
